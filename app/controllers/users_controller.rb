class UsersController < ApplicationController
  before_action :logged_in_user, only: [:index, :edit, :update, :destroy, :following, :followers] #chapter 10.2.1 and listing 10.58 pg 612
  ...
  private
      ...
      #   end 
      # end removed in ch 13 pg 760...moved to base application controller
